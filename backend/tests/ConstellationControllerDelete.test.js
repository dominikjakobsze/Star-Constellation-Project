...
describe('DELETE /constellations/1', () => {
    beforeEach(async () => {
    ...
    it('should return 404 if constellation does not exist', async () => {
        const res = await request(app).delete('/constellations/1');
        expect(res.status).toBe(404);
    });

    it('should delete a constellation of id 1', async () => {
        ...
        const res2 = await request(app).delete('/constellations/1');
